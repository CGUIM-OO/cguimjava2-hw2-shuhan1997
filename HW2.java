...
/**
 * Description: TODO: please add description here:建立3個變數，幾副牌(deck)、牌的花色(flower)、牌的數字(number)。第一個迴圈先跑幾副牌，然後開始跑牌的花色，再來是那個花色裡面牌的數字。
 */
class Deck{
...
/**
 * Description: TODO: please add description here:建立兩個陣列，一個是花色的陣列(SuitArray)，一個是牌上面數字的陣列(RankArray)
 */
class Card{
